...
(function (window, undefined) {
        ...
        enchant.Core = enchant.Class.create(enchant.EventTarget, {
            ...
            start: function () {
                ...
                if (this._assets.length) {
                    ...
                    var loaded = 0, len = assets.length, loadFunc = function () {
    ...
    enchant.Sprite = enchant.Class.create(enchant.Entity, {
        ...
        cvsRender: function (ctx) {
            var image = this._image, w = this._width, h = this._height, iw, ih, elem, sx, sy, sw, sh;
            if (image && w !== 0 && h !== 0) {
                    ...
                    if (this._tight) {
                        ...
                        if (w1 > this._tileWidth && w2 > this._tileWidth &&
                            ...
                            if (this._doubledImage) {
                                ...
                                context.drawImage(this._context.canvas, sx * 2, sy * 2, sw * 2, sh * 2, 0, 0, sw * 2, sh * 2);
                                context = this._context;
                                context.clearRect(dx * 2, dy * 2, sw * 2, sh * 2);
                                context.drawImage(core._buffer, 0, 0, sw * 2, sh * 2, dx * 2, dy * 2, sw * 2, sh * 2);
                            }
                            else {
                                context.clearRect(0, 0, sw, sh);
                                context.drawImage(this._context.canvas, sx, sy, sw, sh, 0, 0, sw, sh);
                                context = this._context;
        ...
        image: {
            ...
            set: function (image) {
                ...
                if (enchant.ENV.RETINA_DISPLAY && core.scale === 2) {
                    ...
                    for (var y = 0; y < col; y++) {
                        for (var x = 0; x < row; x++) {
                            img.draw(image, x * tileWidth, y * tileHeight, tileWidth, tileHeight, x * tileWidth * 2, y * tileHeight * 2, tileWidth * 2, tileHeight * 2);
                        }
                    }
                ...
                for (y = top; y < b; y++) {
                    for (x = left; x < r; x++) {
                        ...
                        if (0 <= n && n < row * col) {
                            ...
                            context.drawImage(source, sx, sy, tileWidth, tileHeight, x * tileWidth - dx, y * tileHeight - dy, tileWidth, tileHeight);
                        }
                    }
                }
            }
    ...
    enchant.Matrix = enchant.Class.create({
        ...
        multiply: function (m1, m2, dest) {
            var a11 = m1[0], a21 = m1[2], adx = m1[4], a12 = m1[1], a22 = m1[3], ady = m1[5];
            var b11 = m2[0], b21 = m2[2], bdx = m2[4], b12 = m2[1], b22 = m2[3], bdy = m2[5];
        ...
        multiplyVec: function (mat, vec, dest) {
            var x = vec[0], y = vec[1];
            var m11 = mat[0], m21 = mat[2], mdx = mat[4], m12 = mat[1], m22 = mat[3], mdy = mat[5];
